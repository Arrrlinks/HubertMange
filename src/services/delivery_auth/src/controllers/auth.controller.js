...
exports.register = async (req, res) => {
    try {
        ...
        const existingEmail = await prisma.delivery.findUnique({where: {email}});
        if (existingEmail) {
...
exports.login = async (req, res) => {
    try {
        ...
        const user = await prisma.delivery.findUnique({where: {email}});
...
exports.auth_google_callback = async (req, res) => {
    ...
    try {
        ...
        let user = await prisma.delivery.findUnique({where: {email}});
        if (!user) {
            user = await prisma.delivery.create({
                data: {
                    username,
                    email,
